...
- Each scenario needs to be linked with its required connectors
- Natalia is automatically aware of all connectors linked to a scenario
- The scenario's description, name, and parameters are automatically added to Natalia's training sheet (main prompt)

### Why Descriptions Matter
- Write clear, detailed descriptions for your scenarios
- Be specific about when and how connectors should be used
- The more detailed your descriptions, the better Natalia understands your intent
